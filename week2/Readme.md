...
**Note:** This assignment emphasizes clean, maintainable code following OOP principles. Focus on proper class design, method organization, and error handling to create a professional-grade library management system.